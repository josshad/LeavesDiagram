...
public final class LeavesDiagramView: UIView {
    ...
    /**
     ...
     - parameter snailFullAngle: Angle between first and last leaf. Default is 2π (360°) — full circle
     - parameter strokeColor: Stroke color of each leaf. If not specified — same color as for leaf
     */
    public init(frame: CGRect, radius: CGFloat = .zero, snailFullAngle: CGFloat = .pi * 2, strokeColor: UIColor? = nil) {
